...
describe('ScranAdvisor', () => {
    ...
    test('can find the name of all restaurants', () => {
        const expected = [
          ...
          const actual = scranAdvisor.findAllNames();
          expect(actual).toEqual(expected);
    })
    ...
    test('can find all restaurants from Glasgow', () => {
        const expected = [
          ...
          const actual = scranAdvisor.findRestaurantByTown("Glasgow");
          expect(actual).toEqual(expected);
    })
    ...
    test('can find the most common cuisine type', () => {
      expect(scranAdvisor.mostCommonCuisine()).toEqual("JAPANESE")
    })
    ...
    test('can find restaurant with substring', () => {
      ...
      expect(scranAdvisor.findBySubstring("ru")).toEqual(expected)
    })
